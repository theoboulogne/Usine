                ...
                if(this.Composant[i].auto){
                    ...
                    if(this.Composant[i].nbRobots+this.Composant[i].nbEmployes == 0) this.marche = false;
                        ...
                        if(!this.boolpanne&&!this.boolaccident){
                            let qualTravail = Math.pow(this.cadence_travail(this.Composant[i], Choix), this.Composant[i].nbEmployes) * Math.pow(3.5, this.Composant[i].nbRobots); // on recalcule si il y a eu de nouveaux accidents, rajouter d'autres modif par la suite en fonction des choix possibles
